...
namespace BugTracker.Controllers
{
    public class TicketPrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PriorityName")] TicketPriority ticketPriority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PriorityName")] TicketPriority ticketPriority)
        {
            if (ModelState.IsValid)
            {
